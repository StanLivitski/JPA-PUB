...
/**
 * Stores the 'description' option of a persistent unit
 * processed by {@link PersistenceUnitBuilder}.
 */
public class DescriptionOption extends PUOption
{
 /**
  * @param unit name or package identifier of the persistent unit
  */
 public DescriptionOption(String unit)
 {
  super(unit, "description");
 }
